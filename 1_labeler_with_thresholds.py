...
train_data = pd.read_csv(r"C:\Users\bokch\PyCharm\Ergonomics\data\set_training_1-2.csv")
unlabeled_test_data = pd.read_csv(r"C:\Users\bokch\PyCharm\Ergonomics\data\set_testing_1-2.csv")
...
Neck_to_Vertical_ang = np.array(unlabeled_test_data['Neck_Vertical_Angle'])
Torso_to_Vertical_ang = np.array(unlabeled_test_data['Torso_Vertical_Angle'])
Threshold_Neck_Vertical_Angle = 139
Threshold_Torso_Vertical_Angle = 17
id_good_posture = np.where((Neck_to_Vertical_ang > Threshold_Neck_Vertical_Angle) &
                           (Torso_to_Vertical_ang < Threshold_Torso_Vertical_Angle))

posture_by_threshold = np.zeros(len(unlabeled_test_data))
posture_by_threshold[id_good_posture] = 1
# unlabeled_test_data['Posture_By_Threshold'] = posture_by_threshold
...
unlabeled_test_data.to_csv(r'C:\Users\bokch\PyCharm\Ergonomics\data\training_set.csv', index=False)
